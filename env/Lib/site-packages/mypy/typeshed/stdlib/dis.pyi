...
class Bytecode:
    ...
    if sys.version_info >= (3, 11):
        ...
        @classmethod
        def from_traceback(
            cls: type[Self], tb: types.TracebackType, *, show_caches: bool = ...
        ) -> Self: ...
    else:
        def __init__(
            self,
...
if sys.version_info >= (3, 11):
    ...
    def dis(
        x: _HaveCodeOrStringType | None = ..., *, file: IO[str] | None = ...
    ) -> None: ...
...
if sys.version_info >= (3, 11):
    ...
    def get_instructions(
        x: _HaveCodeType, *, first_line: int | None = ..., show_caches: bool = ...
