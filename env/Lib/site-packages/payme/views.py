...
class MerchantAPIView(APIView):
    ...
    def post(self, request) -> Response:
        ...
        if self.authorize(password):
            ...
            user_id, action = paycom_method(
                incoming_data.get("params")
            )  # Change order_id to user_id

        if isinstance(paycom_method, CreateTransaction):
            self.create_transaction(
                user_id=user_id,  # Change order_id to user_id
                action=action,
            )
    ...
    def create_transaction(self, user_id, action) -> None:
        """
        Need to implement in your view class
        """
        pass

    def perform_transaction(self, user_id, action) -> None:
        """
        Need to implement in your view class
        """
        pass

    def cancel_transaction(self, user_id, action) -> None:
        """
        Need to implement in your view class
        """
        pass
