...
class PackagesUpgrader(object):
    ...
    def _update_package(self, package):
        ...
        try:
            if (
                not self.dry_run and not self.skip_package_installation
            ):  # pragma: nocover
                ...
                print(
                    "[{}]: skipping package installation:".format(lbl), package["name"]
                )
            ...
            print(
                Color(
                    '{{autored}}Failed to install package "{}"{{/autored}}'.format(
                        package["name"]
                    )
                )
            )
