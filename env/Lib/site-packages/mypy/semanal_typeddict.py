...
class TypedDictAnalyzer:
    ...
    def analyze_typeddict_classdef_fields(
        ...
        required_keys = {
            ...
            if (
                total
                or (isinstance(t, RequiredType) and t.required)  # type: ignore[misc]
            )
            and not (
                isinstance(t, RequiredType) and not t.required  # type: ignore[misc]
            )
        }
        ...
        if not ok:
            ...
            required_keys = {
                ...
                if (
                    total
                    or (
                        isinstance(t, RequiredType) and t.required  # type: ignore[misc]
                    )
                )
                and not (
                    isinstance(t, RequiredType) and not t.required  # type: ignore[misc]
